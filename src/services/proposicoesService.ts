...
export const buscarProposicoes = async (
    ...
    const url = `legis/resources/lex/proposicoes/${sigla}/${ano}` + (numero ? '?numero=' + numero : '')
...
export const buscarProposicao = async (sigla: string, numero: string, ano: number): Promise<Proposicao | null> => {
